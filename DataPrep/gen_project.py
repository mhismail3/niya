...
SWIFT_FILES = [
    ...
    "Niya/Services/CompressedJSON.swift",
    # ViewModels
    ...
    "Niya/Views/Reader/TafsirBlockParser.swift",
    "Niya/Views/Reader/WordEtymologySheet.swift",
    ...
    "Niya/Views/Settings/CreditsView.swift",
...
RESOURCE_FILES = [
    "Niya/Resources/Data/surahs.json.zlib",
    "Niya/Resources/Data/verses_hafs.json.zlib",
    "Niya/Resources/Data/verses_indopak.json.zlib",
    "Niya/Resources/Data/hadith_collections.json.zlib",
    "Niya/Resources/Data/hadith_bukhari.json.zlib",
    "Niya/Resources/Data/hadith_muslim.json.zlib",
    "Niya/Resources/Data/hadith_abudawud.json.zlib",
    "Niya/Resources/Data/hadith_tirmidhi.json.zlib",
    "Niya/Resources/Data/hadith_nasai.json.zlib",
    "Niya/Resources/Data/hadith_ibnmajah.json.zlib",
    "Niya/Resources/Data/hadith_malik.json.zlib",
    "Niya/Resources/Data/hadith_ahmed.json.zlib",
    "Niya/Resources/Data/hadith_darimi.json.zlib",
    "Niya/Resources/Data/hadith_nawawi.json.zlib",
    "Niya/Resources/Data/hadith_qudsi.json.zlib",
    "Niya/Resources/Data/hadith_dehlawi.json.zlib",
    "Niya/Resources/Data/hadith_aladab.json.zlib",
    "Niya/Resources/Data/hadith_bulugh.json.zlib",
    "Niya/Resources/Data/hadith_mishkat.json.zlib",
    "Niya/Resources/Data/hadith_riyad.json.zlib",
    "Niya/Resources/Data/hadith_shamail.json.zlib",
    "Niya/Resources/Data/dua_all.json.zlib",
    "Niya/Resources/Data/dua_id_migration.json.zlib",
    "Niya/Resources/Data/tajweed_hafs.json.zlib",
    "Niya/Resources/Data/word_morphology.json.zlib",
    "Niya/Resources/Data/root_meanings.json.zlib",
    "Niya/Resources/Data/word_data.json.zlib",
    "Niya/Resources/Data/noreen_word_data.json.zlib",
    "Niya/Resources/Data/word_data_abdulbaset.json.zlib",
    "Niya/Resources/Data/word_data_sudais.json.zlib",
    "Niya/Resources/Data/word_data_shatri.json.zlib",
    "Niya/Resources/Data/word_data_hanirifai.json.zlib",
    "Niya/Resources/Data/word_data_husary.json.zlib",
    "Niya/Resources/Data/word_data_shuraym.json.zlib",
    "Niya/Resources/Data/word_data_bukhatir.json.zlib",
    "Niya/Resources/Data/word_meanings_ur.json.zlib",
    "Niya/Resources/Data/word_meanings_bn.json.zlib",
    "Niya/Resources/Data/word_meanings_tr.json.zlib",
    "Niya/Resources/Data/word_meanings_id.json.zlib",
    "Niya/Resources/Data/word_meanings_fa.json.zlib",
    "Niya/Resources/Data/word_meanings_hi.json.zlib",
    "Niya/Resources/Data/word_meanings_ta.json.zlib",
    "Niya/Resources/Data/translations_index.json.zlib",
    "Niya/Resources/Data/translation_en_sahih.json.zlib",
    "Niya/Resources/Data/translation_en_clearquran.json.zlib",
    "Niya/Resources/Data/translation_en_hilali.json.zlib",
    "Niya/Resources/Data/translation_fr_hamidullah.json.zlib",
    "Niya/Resources/Data/translation_es_garcia.json.zlib",
    ...
    "Niya/Resources/Data/translation_fa_khorramdel.json.zlib",
    ...
    "Niya/Resources/Data/translation_ru_kuliev.json.zlib",
    "Niya/Resources/Data/translation_ms_basmeih.json.zlib",
    "Niya/Resources/Data/translation_zh_jian.json.zlib",
    "Niya/Resources/Data/translation_my_ghazi.json.zlib",
] + [
...
TEST_FILES = [
    ...
    "NiyaTests/PrayerNotificationSchedulerTests.swift",
    "NiyaTests/AppUpdateReminderSchedulerTests.swift",
    ...
    "NiyaTests/WidgetPrayerDataTests.swift",
    "NiyaTests/WidgetDataWriterTests.swift",
    "NiyaTests/HijriFormatterTests.swift",
    "NiyaTests/PrayerTimelineProviderTests.swift",
    "NiyaTests/WidgetPrayerStateTests.swift",
    ...
    "NiyaTests/ReciterURLTests.swift",
    "NiyaTests/CompressedJSONTests.swift",
]

# Widget extension files
WIDGET_FILES = [
    "NiyaWidgets/NiyaWidgetBundle.swift",
    "NiyaWidgets/Provider/PrayerTimelineProvider.swift",
    "NiyaWidgets/Models/WidgetPrayerData.swift",
    "NiyaWidgets/Models/PrayerTimeEntry.swift",
    "NiyaWidgets/Views/MediumWidgetView.swift",
    "NiyaWidgets/Views/SmallWidgetView.swift",
    "NiyaWidgets/Views/RectangularAccessoryView.swift",
    "NiyaWidgets/Views/PrayerProgressBar.swift",
    "NiyaWidgets/Helpers/HijriFormatter.swift",
    "NiyaWidgets/Helpers/WidgetConstants.swift",
]

# Files from main app compiled also into widget target
WIDGET_SHARED_FILES = [
    "Niya/Services/PrayerTimeCalculator.swift",
    "Niya/Services/WidgetDataWriter.swift",
    "Niya/Models/PrayerTime.swift",
...
ID_WIDGETS_GROUP    = new_id()   # "NiyaWidgets" source group
...
ID_WIDGET_SOURCES_PHASE = new_id()
ID_WIDGET_RESOURCES_PHASE = new_id()
ID_WIDGET_FRAMEWORKS_PHASE = new_id()
ID_EMBED_EXTENSIONS_PHASE = new_id()
...
ID_DEBUG_WIDGET_TARGET  = new_id()
ID_RELEASE_WIDGET_TARGET = new_id()
ID_CFGLIST_PROJECT  = new_id()
ID_CFGLIST_TARGET   = new_id()
ID_CFGLIST_TEST_TARGET = new_id()
ID_CFGLIST_WIDGET_TARGET = new_id()

# Product file reference
ID_PRODUCT_REF      = new_id()
ID_TEST_PRODUCT_REF = new_id()
ID_WIDGET_PRODUCT_REF = new_id()

# Target dependency
ID_TARGET_DEPENDENCY = new_id()
ID_CONTAINER_ITEM_PROXY = new_id()
ID_WIDGET_TARGET_DEPENDENCY = new_id()
ID_WIDGET_CONTAINER_ITEM_PROXY = new_id()

# Widget embed build file ref
ID_WIDGET_EMBED_BUILD = new_id()
...
widget_file_ids  = {p: new_id() for p in WIDGET_FILES}
widget_build_ids = {p: new_id() for p in WIDGET_FILES}

# Build IDs for shared files compiled into widget target
widget_shared_build_ids = {p: new_id() for p in WIDGET_SHARED_FILES}

# Build IDs for widget files compiled into main app
app_shared_widget_build_ids = {p: new_id() for p in APP_SHARED_WIDGET_FILES}

# Widget assets build ID
ID_WIDGET_ASSETS_BUILD = new_id()
...
def section_pbx_build_file():
    ...
    for path in WIDGET_FILES:
        bid = widget_build_ids[path]
        fid = widget_file_ids[path]
        name = basename(path)
        lines.append(f"\t\t{bid} /* {name} in Sources */ = {{isa = PBXBuildFile; fileRef = {fid} /* {name} */; }};")

    # Shared files compiled into widget target
    for path in WIDGET_SHARED_FILES:
        bid = widget_shared_build_ids[path]
        fid = swift_file_ids[path]
        name = basename(path)
        lines.append(f"\t\t{bid} /* {name} in Sources */ = {{isa = PBXBuildFile; fileRef = {fid} /* {name} */; }};")

    # Widget files compiled into main app
    for path in APP_SHARED_WIDGET_FILES:
        bid = app_shared_widget_build_ids[path]
        fid = widget_file_ids[path]
        name = basename(path)
        lines.append(f"\t\t{bid} /* {name} in Sources */ = {{isa = PBXBuildFile; fileRef = {fid} /* {name} */; }};")
...
def section_pbx_file_reference():
    ...
    lines.append(f"\t\t{ID_WIDGET_PRODUCT_REF} /* NiyaWidgets.appex */ = {{isa = PBXFileReference; explicitFileType = \"wrapper.app-extension\"; includeInIndex = 0; path = NiyaWidgets.appex; sourceTree = BUILT_PRODUCTS_DIR; }};")
...
def section_pbx_group():
    ...
    lines += [
        ...
        f"\t\t\t\t{ID_WIDGETS_GROUP} /* NiyaWidgets */,",
    ...
    lines += [
        ...
        f"\t\t\t\t{ID_WIDGET_PRODUCT_REF} /* NiyaWidgets.appex */,",
        "\t\t\t);",
        "\t\t\tname = Products;",
        "\t\t\tsourceTree = \"<group>\";",
        "\t\t};",
    ...
    # Shared
    emit_subgroup(SUBGROUP_IDS["Shared"], "Shared", "Shared", [
        (swift_file_ids["Niya/Shared/SharedConstants.swift"], "SharedConstants.swift"),
    ], path_str="Shared")
    ...
    emit_subgroup(SUBGROUP_IDS["Models"], "Models", "Models", [
        ...
        (swift_file_ids["Niya/Models/WordMorphology.swift"], "WordMorphology.swift"),
        ...
        (swift_file_ids["Niya/Models/TafsirBlock.swift"], "TafsirBlock.swift"),
    ...
    emit_subgroup(SUBGROUP_IDS["Services"], "Services", "Services", [
        ...
        (swift_file_ids["Niya/Services/DuaDataMigration.swift"], "DuaDataMigration.swift"),
        ...
        (swift_file_ids["Niya/Services/MorphologyService.swift"], "MorphologyService.swift"),
        ...
        (swift_file_ids["Niya/Services/CompressedJSON.swift"], "CompressedJSON.swift"),
    ], path_str="Services")
    ...
    emit_subgroup(SUBGROUP_IDS["Views/Reader"], "Reader", "Views/Reader", [
        ...
        (swift_file_ids["Niya/Views/Reader/TafsirBlockParser.swift"], "TafsirBlockParser.swift"),
        (swift_file_ids["Niya/Views/Reader/WordEtymologySheet.swift"], "WordEtymologySheet.swift"),
    ...
    emit_subgroup(SUBGROUP_IDS["Views/Settings"], "Settings", "Views/Settings", [
        ...
        (swift_file_ids["Niya/Views/Settings/CreditsView.swift"], "CreditsView.swift"),
    ...
    # Resources/Data
    data_children = [
        (resource_file_ids["Niya/Resources/Data/surahs.json.zlib"],        "surahs.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/verses_hafs.json.zlib"],   "verses_hafs.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/verses_indopak.json.zlib"],"verses_indopak.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/hadith_collections.json.zlib"], "hadith_collections.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/dua_all.json.zlib"], "dua_all.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/dua_id_migration.json.zlib"], "dua_id_migration.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/tajweed_hafs.json.zlib"], "tajweed_hafs.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_morphology.json.zlib"], "word_morphology.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/root_meanings.json.zlib"], "root_meanings.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_data.json.zlib"], "word_data.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/noreen_word_data.json.zlib"], "noreen_word_data.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_data_abdulbaset.json.zlib"], "word_data_abdulbaset.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_data_sudais.json.zlib"], "word_data_sudais.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_data_shatri.json.zlib"], "word_data_shatri.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_data_hanirifai.json.zlib"], "word_data_hanirifai.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_data_husary.json.zlib"], "word_data_husary.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_data_shuraym.json.zlib"], "word_data_shuraym.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_data_bukhatir.json.zlib"], "word_data_bukhatir.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_meanings_ur.json.zlib"], "word_meanings_ur.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_meanings_bn.json.zlib"], "word_meanings_bn.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_meanings_tr.json.zlib"], "word_meanings_tr.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_meanings_id.json.zlib"], "word_meanings_id.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_meanings_fa.json.zlib"], "word_meanings_fa.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_meanings_hi.json.zlib"], "word_meanings_hi.json.zlib"),
        (resource_file_ids["Niya/Resources/Data/word_meanings_ta.json.zlib"], "word_meanings_ta.json.zlib"),
    ...
    for tid in ["en_sahih", "en_clearquran", "en_hilali", "fr_hamidullah",
                 "es_garcia", "it_piccardo", "tr_diyanet", "ur_maududi",
                 "ps_abdulwali", "ps_rwwad", "fa_khorramdel",
    ...
    for coll_id in ["bukhari", "muslim", "abudawud", "tirmidhi", "nasai", "ibnmajah",
        ...
        fname = f"hadith_{coll_id}.json.zlib"
        data_children.append((resource_file_ids[f"Niya/Resources/Data/{fname}"], fname))
    ...
    widget_top_children = [
        ...
        (WIDGET_SUBGROUP_IDS["Views"], "Views"),
        (WIDGET_SUBGROUP_IDS["Helpers"], "Helpers"),
    ]
    emit_subgroup(ID_WIDGETS_GROUP, "NiyaWidgets", "NiyaWidgets", widget_top_children, path_str="NiyaWidgets")

    # NiyaWidgets/Provider
    emit_subgroup(WIDGET_SUBGROUP_IDS["Provider"], "Provider", "NiyaWidgets/Provider", [
        (widget_file_ids["NiyaWidgets/Provider/PrayerTimelineProvider.swift"], "PrayerTimelineProvider.swift"),
    ], path_str="Provider")

    # NiyaWidgets/Models
    emit_subgroup(WIDGET_SUBGROUP_IDS["Models"], "Models", "NiyaWidgets/Models", [
        (widget_file_ids["NiyaWidgets/Models/WidgetPrayerData.swift"], "WidgetPrayerData.swift"),
        (widget_file_ids["NiyaWidgets/Models/PrayerTimeEntry.swift"], "PrayerTimeEntry.swift"),
    ], path_str="Models")

    # NiyaWidgets/Views
    emit_subgroup(WIDGET_SUBGROUP_IDS["Views"], "Views", "NiyaWidgets/Views", [
        (widget_file_ids["NiyaWidgets/Views/MediumWidgetView.swift"], "MediumWidgetView.swift"),
        (widget_file_ids["NiyaWidgets/Views/SmallWidgetView.swift"], "SmallWidgetView.swift"),
        (widget_file_ids["NiyaWidgets/Views/RectangularAccessoryView.swift"], "RectangularAccessoryView.swift"),
        (widget_file_ids["NiyaWidgets/Views/PrayerProgressBar.swift"], "PrayerProgressBar.swift"),
    ], path_str="Views")

    # NiyaWidgets/Helpers
    emit_subgroup(WIDGET_SUBGROUP_IDS["Helpers"], "Helpers", "NiyaWidgets/Helpers", [
        (widget_file_ids["NiyaWidgets/Helpers/HijriFormatter.swift"], "HijriFormatter.swift"),
        (widget_file_ids["NiyaWidgets/Helpers/WidgetConstants.swift"], "WidgetConstants.swift"),
    ], path_str="Helpers")
...
def section_pbx_container_item_proxy():
    lines = [
        ...
        "\t\t\tremoteInfo = Niya;",
        "\t\t};",
        f"\t\t{ID_WIDGET_CONTAINER_ITEM_PROXY} /* PBXContainerItemProxy */ = {{",
        "\t\t\tisa = PBXContainerItemProxy;",
        f"\t\t\tcontainerPortal = {ID_PROJECT} /* Project object */;",
        "\t\t\tproxyType = 1;",
        f"\t\t\tremoteGlobalIDString = {ID_WIDGET_TARGET};",
        "\t\t\tremoteInfo = NiyaWidgets;",
        "\t\t};",
...
def section_pbx_target_dependency():
    lines = [
        ...
        "\t\t};",
        f"\t\t{ID_WIDGET_TARGET_DEPENDENCY} /* PBXTargetDependency */ = {{",
        "\t\t\tisa = PBXTargetDependency;",
        f"\t\t\ttarget = {ID_WIDGET_TARGET} /* NiyaWidgets */;",
        f"\t\t\ttargetProxy = {ID_WIDGET_CONTAINER_ITEM_PROXY} /* PBXContainerItemProxy */;",
        "\t\t};",
...
def section_pbx_native_target():
    lines = [
        ...
        "\t\t};",
        f"\t\t{ID_WIDGET_TARGET} /* NiyaWidgets */ = {{",
        "\t\t\tisa = PBXNativeTarget;",
        f"\t\t\tbuildConfigurationList = {ID_CFGLIST_WIDGET_TARGET} /* Build configuration list for PBXNativeTarget \"NiyaWidgets\" */;",
        "\t\t\tbuildPhases = (",
        f"\t\t\t\t{ID_WIDGET_SOURCES_PHASE} /* Sources */,",
        f"\t\t\t\t{ID_WIDGET_RESOURCES_PHASE} /* Resources */,",
        f"\t\t\t\t{ID_WIDGET_FRAMEWORKS_PHASE} /* Frameworks */,",
        "\t\t\t);",
        "\t\t\tbuildRules = (",
        "\t\t\t);",
        "\t\t\tdependencies = (",
        "\t\t\t);",
        "\t\t\tname = NiyaWidgets;",
        "\t\t\tproductName = NiyaWidgets;",
        f"\t\t\tproductReference = {ID_WIDGET_PRODUCT_REF} /* NiyaWidgets.appex */;",
...
def section_pbx_sources_build_phase():
    ...
    # Widget files also compiled into main app
    for path in APP_SHARED_WIDGET_FILES:
        bid = app_shared_widget_build_ids[path]
        name = basename(path)
        lines.append(f"\t\t\t\t{bid} /* {name} in Sources */,")
...
def section_widget_sources_build_phase():
    lines = [
        f"\t\t{ID_WIDGET_SOURCES_PHASE} /* Sources */ = {{",
        "\t\t\tisa = PBXSourcesBuildPhase;",
        "\t\t\tbuildActionMask = 2147483647;",
...
def section_widget_resources_build_phase():
    lines = [
        f"\t\t{ID_WIDGET_RESOURCES_PHASE} /* Resources */ = {{",
        "\t\t\tisa = PBXResourcesBuildPhase;",
        "\t\t\tbuildActionMask = 2147483647;",
...
def section_widget_frameworks_build_phase():
    lines = [
        f"\t\t{ID_WIDGET_FRAMEWORKS_PHASE} /* Frameworks */ = {{",
        "\t\t\tisa = PBXFrameworksBuildPhase;",
        "\t\t\tbuildActionMask = 2147483647;",
...
def build_settings_widget_target(config):
    lines = [
        ...
        f"\t\t\t\tPRODUCT_BUNDLE_IDENTIFIER = {BUNDLE_ID}.widgets;",
...
def section_xcbuild_configuration_list():
    ...
    debug_widget_settings = build_settings_widget_target("Debug")
    release_widget_settings = build_settings_widget_target("Release")
    ...
    lines = [
        ...
        "\t\t\tname = Release;",
        "\t\t};",
        f"\t\t{ID_DEBUG_WIDGET_TARGET} /* Debug */ = {{",
        "\t\t\tisa = XCBuildConfiguration;",
        "\t\t\tbuildSettings = {",
        debug_widget_settings,
        "\t\t\t};",
        "\t\t\tname = Debug;",
        "\t\t};",
        f"\t\t{ID_RELEASE_WIDGET_TARGET} /* Release */ = {{",
        "\t\t\tisa = XCBuildConfiguration;",
        "\t\t\tbuildSettings = {",
        release_widget_settings,
        "\t\t\t};",
        "\t\t\tname = Release;",
        "\t\t};",
...
def section_xcconfiguration_list():
    lines = [
        ...
        "\t\t\tdefaultConfigurationName = Release;",
        "\t\t};",
        f"\t\t{ID_CFGLIST_WIDGET_TARGET} /* Build configuration list for PBXNativeTarget \"NiyaWidgets\" */ = {{",
        "\t\t\tisa = XCConfigurationList;",
        "\t\t\tbuildConfigurations = (",
        f"\t\t\t\t{ID_DEBUG_WIDGET_TARGET} /* Debug */,",
        f"\t\t\t\t{ID_RELEASE_WIDGET_TARGET} /* Release */,",
...
def generate():
    sections = [
        ...
        section_widget_sources_build_phase(),
        section_widget_resources_build_phase(),
        section_widget_frameworks_build_phase(),
        section_embed_extensions_build_phase(),
