...
struct WordView: View {
    ...
    private var arabicLineHeight: CGFloat {
        let uiFont = UIFont(name: QuranScript.hafs.fontName, size: arabicFontSize)
            ?? .systemFont(ofSize: arabicFontSize)
        return ceil(uiFont.ascender + abs(uiFont.descender))
    }
