...
extension UIColor {
    ...
    static let idghamGhunnah = UIColor(light: 0x006064, dark: 0x26C6DA)
    static let idghamNoGhunnah = UIColor(light: 0x283593, dark: 0x7986CB)
    static let iqlab = UIColor(light: 0x6A1B9A, dark: 0xBA68C8)
    static let ikhfaShafawi = UIColor(light: 0xC62828, dark: 0xEF5350)
    static let idghamMutajanisayn = UIColor(light: 0x4527A0, dark: 0x9575CD)
    static let idghamShafawi = UIColor(light: 0x00838F, dark: 0x4DD0E1)
    static let idghamMutaqaribayn = UIColor(light: 0x8E24AA, dark: 0xCE93D8)
    static let lamJalalah = UIColor(light: 0xF9A825, dark: 0xFFD54F)
    static let raTafkheem = UIColor(light: 0x9E9D24, dark: 0xD4E157)
    static let raTarqeeq = UIColor(light: 0x00897B, dark: 0x4DB6AC)
    static let idhaar = UIColor(light: 0xAD1457, dark: 0xF06292)
